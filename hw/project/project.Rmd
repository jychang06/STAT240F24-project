...
means = tibble(age = c("18-24", "25-34", "35-44", "45-54", "55-64", "65+"), x = x, n = n, p = p, se = se_single)
...
ggplot(drug_mod, aes(y = usage_prop, color = age)) +
  ...
  labs(title = "Proportion of age group that drinks", y = "Proportion", color = "Age group")
```
