...
drugPropsArr = drugProps %>%
  arrange(desc(drugProps$usageProp))
drugPropsArr
```

```{r}
ggplot(drugPropsArr, aes(x = Drugs, y = usageProp)) + 
  geom_bar(stat="identity",fill='blue', alpha=0.5)+
  theme(axis.text.x = element_text(angle=45, hjust=1)) +
  labs(
    title="Proportion of Drug Consumption Across Data-set",
    x = "Drug Consumed",
...
* Now I'm going to begin grouping by different age groups. 
